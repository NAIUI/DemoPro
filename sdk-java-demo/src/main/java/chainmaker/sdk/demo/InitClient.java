...
public class InitClient {
    ...
    static final String CLIENT1_KEY_PATH = "crypto-config/org5.cmtestnet/user/client/sign.key";
    static final String CLIENT1_CERT_PATH = "crypto-config/org5.cmtestnet/user/client/sign.crt";

    static String CLIENT1_TLS_KEY_PATH = "crypto-config/org5.cmtestnet/user/client/tls.key";
    static String CLIENT1_TLS_CERT_PATH = "crypto-config/org5.cmtestnet/user/client/tls.crt";

    static final String ORG_ID1 = "yunnan";
