...
func (f *LocationContract) AddLocation() protogo.Response {
	...
	res := sdk.Instance.CallContract("ResultContract", "QueryWorkerList", crossContractArgs)
	r := res.GetPayload()
	...
	sdk.Instance.CallContract("ResultContract", "UpdateWorkerList", crossContractArgs2)
	// 记录日志
