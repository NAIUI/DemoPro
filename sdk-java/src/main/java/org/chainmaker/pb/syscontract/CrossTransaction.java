...
public final class CrossTransaction {
  ...
  /**
   * Protobuf enum {@code syscontract.CallType}
   */
  public enum CallType
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return org.chainmaker.pb.syscontract.CrossTransaction.getDescriptor().getEnumTypes().get(3);
    }
    ...
    // @@protoc_insertion_point(enum_scope:syscontract.CallType)
  }

  /**
   * Protobuf enum {@code syscontract.CrossParams}
   */
  public enum CrossParams
      implements com.google.protobuf.ProtocolMessageEnum {
    /**
     * <code>CREATOR = 0;</code>
     */
     ...
     * <code>CALL_TYPE = 2;</code>
     */
    public static final int CALL_TYPE_VALUE = 2;
     ...
     */
    @java.lang.Deprecated
    public static CrossParams valueOf(int value) {
      return forNumber(value);
    }

    public static CrossParams forNumber(int value) {
      switch (value) {
        case 0: return CREATOR;
        case 1: return SENDER;
        case 2: return CALL_TYPE;
        default: return null;
      }
    }

    public static com.google.protobuf.Internal.EnumLiteMap<CrossParams>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static final com.google.protobuf.Internal.EnumLiteMap<
        CrossParams> internalValueMap =
          new com.google.protobuf.Internal.EnumLiteMap<CrossParams>() {
            public CrossParams findValueByNumber(int number) {
              return CrossParams.forNumber(number);
            }
          };
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return org.chainmaker.pb.syscontract.CrossTransaction.getDescriptor().getEnumTypes().get(4);
    }

    private static final CrossParams[] VALUES = values();

    public static CrossParams valueOf(
        com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
      if (desc.getType() != getDescriptor()) {
        throw new java.lang.IllegalArgumentException(
          "EnumValueDescriptor is not for this type.");
    ...
    private CrossParams(int value) {
      this.value = value;
    }

    // @@protoc_insertion_point(enum_scope:syscontract.CrossParams)
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "MIT_CMD\020\002\022\020\n\014ROLLBACK_CMD\020\003*!\n\010CallType\022" +
      "\n\n\006DIRECT\020\000\022\t\n\005CROSS\020\001*5\n\013CrossParams\022\013\n" +
      "\007CREATOR\020\000\022\n\n\006SENDER\020\001\022\r\n\tCALL_TYPE\020\002BO\n" +
      "\035org.chainmaker.pb.syscontractZ.chainmak" +
      "er.org/chainmaker/pb-go/v2/syscontractb\006" +
      "proto3"
    };
