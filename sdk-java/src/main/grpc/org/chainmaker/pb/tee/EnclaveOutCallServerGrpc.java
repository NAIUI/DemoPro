...
public final class EnclaveOutCallServerGrpc {
  ...
  public static EnclaveOutCallServerStub newStub(io.grpc.Channel channel) {
    return new EnclaveOutCallServerStub(channel);
  }
  ...
  public static EnclaveOutCallServerBlockingStub newBlockingStub(
    ...
    return new EnclaveOutCallServerBlockingStub(channel);
  }
  ...
  public static EnclaveOutCallServerFutureStub newFutureStub(
      io.grpc.Channel channel) {
    return new EnclaveOutCallServerFutureStub(channel);
  }
  ...
  public static abstract class EnclaveOutCallServerImplBase implements io.grpc.BindableService {
    ...
    public void outCallGet(org.chainmaker.pb.tee.EnclaveOutcall.OutCallGetRequest request,
      ...
      asyncUnimplementedUnaryCall(getOutCallGetMethod(), responseObserver);
    }
    ...
    public void outCallPut(org.chainmaker.pb.tee.EnclaveOutcall.OutCallPutRequest request,
        io.grpc.stub.StreamObserver<org.chainmaker.pb.common.ResultOuterClass.ContractResult> responseObserver) {
      asyncUnimplementedUnaryCall(getOutCallPutMethod(), responseObserver);
    }
  ...
  /**
   */
  public static final class EnclaveOutCallServerStub extends io.grpc.stub.AbstractStub<EnclaveOutCallServerStub> {
    private EnclaveOutCallServerStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @java.lang.Override
    protected EnclaveOutCallServerStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class EnclaveOutCallServerBlockingStub extends io.grpc.stub.AbstractStub<EnclaveOutCallServerBlockingStub> {
    private EnclaveOutCallServerBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @java.lang.Override
    protected EnclaveOutCallServerBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  /**
   */
  public static final class EnclaveOutCallServerFutureStub extends io.grpc.stub.AbstractStub<EnclaveOutCallServerFutureStub> {
    private EnclaveOutCallServerFutureStub(io.grpc.Channel channel) {
      super(channel);
    }
    ...
    @java.lang.Override
    protected EnclaveOutCallServerFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
